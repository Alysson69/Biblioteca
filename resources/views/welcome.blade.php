...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <canvas class="my-4 w-100" id="myChart" width="1076" height="454" style="display: block; box-sizing: border-box; height: 454px; width: 1076px;"></canvas>
...
<script src=" {{ asset('js/deshboard.js')}} "></script>
